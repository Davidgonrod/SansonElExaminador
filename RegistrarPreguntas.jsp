				...
				<section class="main row">
					<article class="col-md-9">
					 <h2 class="post-contenido text-justify">
						 En este espacio podr&#225;s registrar tus preguntas
					 </h2>
					</article>
						<br> <br> <br> <br> <br>
							<br>
						<div class="row">
						 <div class="color2 col-md-6">
							 ...
							 <div class="input-group col-md-8">
							  ...
							  <!--Cargado de email-->
							  Ingrese su pregunta</p>  
							<div class="input-group col-md-8">
				 			  <span class="input-group-addon glyphicon glyphicon-file" id="basic-addon1"></span>
				 			  <input type="text" name="pregunta" class="form-control" aria-describedby="basic-addon1">
							</div><p><br>
						  <form  action="index.html" method="GET">
							  <div id="preguntas" class="input-group col-md-8">
							    <input type="hidden" value="1" id="noPreguntas">
							    <div name="pregunta0" class="input-group col-md-8">
						      <p>
							 <div class="input-group col-md-8">
				 			  <span class="input-group-addon glyphicon glyphicon-file" id="basic-addon1"></span>
				 			  <input type="text" name="categoria0" placeholder="categoria" class="form-control" aria-describedby="basic-addon1">
							</div><p><br>
						        Tipo de pregunta
							<div class="radio"><label>
						        <input type="radio" name="tipo0" value="VerFal" onchange="cambioRadio()">Verdadero o Falso</label></div>
							<div class="radio"><label>
						        <input type="radio" name="tipo0" value="OpcionesPer" onchange="cambioRadio()">Opci&oacute;n m&uacute;ltiple</label></div>
							<div class="checkbox"><label>
						        <input type="checkbox" name="obligatoria0" > Obligatoria</label></div>
    </p>
    <div id="correcto0">
      <!-- Aqui pondré las opciones para seleccionar Correcta y llenar campo opciones y sel correcta-->
    </div>
  </div>
<button type="submit" id="addPregunta0" name="addPregunta" class="btn btn-info center-block" value="Agregar pregunta" onclick="addingPregunta()">
